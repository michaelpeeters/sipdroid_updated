...
SPAN_DECLARE(int)
t38_terminal_send_timeout(t38_terminal_state_t * s , int samples ) ;

SPAN_DECLARE(void)
t38_terminal_set_config(t38_terminal_state_t * s , int without_pacing ) ;
...
*/
SPAN_DECLARE(void)
t38_terminal_set_tep_mode(t38_terminal_state_t * s , int use_tep ) ;
...
*/
SPAN_DECLARE(void)
t38_terminal_set_fill_bit_removal(t38_terminal_state_t * s , int remove ) ;
...
SPAN_DECLARE(int)
t38_terminal_release(t38_terminal_state_t * s ) ;
...
/*! Free a a termination mode T.38 context.
    ...
    \return 0 for OK, else -1. */
SPAN_DECLARE(int)
t38_terminal_free(t38_terminal_state_t * s ) ;
