...
dds_phase_rate(float frequency);
...
SPAN_DECLARE(int16_t)
dds_offset(uint32_t
phase_acc , int32_t phase_offset ) ;
...
*/
SPAN_DECLARE(int16_t)
dds_mod(uint32_t * phase_acc , int32_t phase_rate, int16_t
scale , int32_t phase ) ;
...
*/
SPAN_DECLARE(complexi_t)
dds_complexi(uint32_t * phase_acc , int32_t phase_rate ) ;
...
*/
SPAN_DECLARE(complexi_t)
dds_complexi_mod(uint32_t * phase_acc , int32_t phase_rate, int16_t
scale , int32_t phase ) ;
...
dds_lookup_complexi16(uint32_t
phase ) ;
...
*/
SPAN_DECLARE(complexi16_t)
dds_complexi16(uint32_t * phase_acc , int32_t phase_rate ) ;
...
*/
SPAN_DECLARE(complexi16_t)
dds_complexi16_mod(uint32_t * phase_acc , int32_t phase_rate, int16_t
scale , int32_t phase ) ;
...
dds_complexi32_mod(uint32_t * phase_acc , int32_t phase_rate, int16_t
scale , int32_t phase ) ;
...
*/
SPAN_DECLARE(complexi32_t)
dds_lookup_complexi32(uint32_t
phase ) ;
...
*/
SPAN_DECLARE(complexi32_t)
dds_complexi32(uint32_t * phase_acc , int32_t phase_rate ) ;
...
*/
SPAN_DECLARE(int32_t)
dds_phase_ratef(float frequency);
...
dds_complexf(uint32_t * phase_acc , int32_t phase_rate ) ;
...
*/
SPAN_DECLARE(complexf_t)
dds_complex_modf(uint32_t * phase_acc , int32_t phase_rate,
float scale, int32_t
phase ) ;
