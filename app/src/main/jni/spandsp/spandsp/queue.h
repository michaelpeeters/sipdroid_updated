...
SPAN_DECLARE(int)
queue_free_space(queue_state_t * s ) ;
...
SPAN_DECLARE(int)
queue_view(queue_state_t * s , uint8_t *buf,
int len ) ;
...
/*! Read bytes from a queue.
    ...
    \return the number of bytes returned. */
SPAN_DECLARE(int)
queue_read(queue_state_t * s , uint8_t *buf,
int len ) ;
...
SPAN_DECLARE(int)
queue_read_byte(queue_state_t * s ) ;
...
SPAN_DECLARE(int)
queue_write(queue_state_t * s , const uint8_t *buf,
int len ) ;
...
/*! Write a byte to a queue.
    ...
    \return the number of bytes actually written. */
SPAN_DECLARE(int)
queue_write_byte(queue_state_t * s , uint8_t byte ) ;
...
SPAN_DECLARE(int)
queue_state_test_msg(queue_state_t * s ) ;
...
/*! Read a message from a queue. If the message is longer than the buffer
    ...
    \return The number of bytes returned. If there are
            no messages in the queue, -1 is returned. */
SPAN_DECLARE(int)
queue_read_msg(queue_state_t * s , uint8_t *buf,
int len ) ;
...
/*! Write a message to a queue.
    ...
    \return The number of bytes actually written. */
SPAN_DECLARE(int)
queue_write_msg(queue_state_t * s , const uint8_t *buf,
int len ) ;
...
SPAN_DECLARE(queue_state_t * ) queue_init(queue_state_t * s , int len,
int flags ) ;
