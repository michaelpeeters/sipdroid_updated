...
signal_status_to_str(int status);
...
SPAN_DECLARE(int)
async_tx_release(async_tx_state_t * s ) ;

SPAN_DECLARE(int)
async_tx_free(async_tx_state_t * s ) ;
...
async_tx_get_bit(void *user_data);
...
SPAN_DECLARE(int)
async_rx_release(async_rx_state_t * s ) ;

SPAN_DECLARE(int)
async_rx_free(async_rx_state_t * s ) ;
...
async_rx_put_bit(void *user_data, int bit);
