...
silence_gen(silence_gen_state_t * s , int16_t *amp,
int max_len ) ;
...
*/
SPAN_DECLARE(void)
silence_gen_always(silence_gen_state_t * s ) ;
...
*/
SPAN_DECLARE(void)
silence_gen_set(silence_gen_state_t * s , int silent_samples ) ;
...
*/
SPAN_DECLARE(int)
silence_gen_remainder(silence_gen_state_t * s ) ;
...
*/
SPAN_DECLARE(int)
silence_gen_generated(silence_gen_state_t * s ) ;
...
SPAN_DECLARE(void)
silence_gen_status_handler(silence_gen_state_t * s , modem_tx_status_func_t handler,
void *user_data ) ;
...
SPAN_DECLARE(int)
silence_gen_release(silence_gen_state_t * s ) ;

SPAN_DECLARE(int)
silence_gen_free(silence_gen_state_t * s ) ;
...
*/
SPAN_DECLARE_NONSTD(int)
span_dummy_rx(void *user_data, const int16_t amp[], int len);
...
*/
SPAN_DECLARE(int)
span_dummy_mod(void *user_data, int16_t amp[], int len);
...
*/
SPAN_DECLARE_NONSTD(int)
span_dummy_rx_fillin(void *user_data, int len);
