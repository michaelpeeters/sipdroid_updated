...
SPAN_DECLARE(void)
v17_tx_power(v17_tx_state_t * s , float power ) ;
...
SPAN_DECLARE(v17_tx_state_t * ) v17_tx_init(v17_tx_state_t * s , int bit_rate,
...
SPAN_DECLARE(int)
v17_tx_restart(v17_tx_state_t * s , int bit_rate,
int tep,
int short_train ) ;
...
/*! Release a V.17 modem transmit context.
    ...
    \return 0 for OK */
SPAN_DECLARE(int)
v17_tx_release(v17_tx_state_t * s ) ;
...
/*! Change the get_bit function associated with a V.17 modem transmit context.
    ...
    \param user_data An opaque pointer. */
SPAN_DECLARE(void)
v17_tx_set_get_bit(v17_tx_state_t * s , get_bit_func_t get_bit,
void *user_data ) ;
...
/*! Change the modem status report function associated with a V.17 modem transmit context.
    ...
    \param user_data An opaque pointer. */
SPAN_DECLARE(void)
v17_tx_set_modem_status_handler(v17_tx_state_t * s , modem_tx_status_func_t handler,
void *user_data ) ;
...
v17_tx(v17_tx_state_t * s , int16_t amp[],
int len ) ;
