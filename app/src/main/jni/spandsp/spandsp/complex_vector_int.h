...
cvec_dot_prodi16(const complexi16_t x[], const complexi16_t y[], int n);
...
/*! \brief Find the dot product of two complex int32_t vectors.
    ...
    \return The dot product of the two vectors. */
SPAN_DECLARE(complexi32_t)
cvec_dot_prodi32(const complexi32_t x[], const complexi32_t y[], int n);
...
/*! \brief Find the dot product of two complex int16_t vectors, where the first is a circular buffer
    ...
    \return The dot product of the two vectors. */
SPAN_DECLARE(complexi32_t)
cvec_circular_dot_prodi16(const complexi16_t x[], const complexi16_t y[], int n, int pos);

SPAN_DECLARE(void)
cvec_lmsi16(const complexi16_t x[], complexi16_t y[], int n, const complexi16_t *error);

SPAN_DECLARE(void)
cvec_circular_lmsi16(const complexi16_t x[], complexi16_t y[], int n, int pos,
                     const complexi16_t *error);
