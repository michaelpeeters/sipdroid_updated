...
*/
SPAN_DECLARE(void)
modem_echo_can_free(modem_echo_can_state_t * ec ) ;

/*! Flush (reinitialise) a modem echo canceller context.
    \param ec The echo canceller context.
*/
SPAN_DECLARE(void)
modem_echo_can_flush(modem_echo_can_state_t * ec ) ;
...
*/
SPAN_DECLARE(void)
modem_echo_can_adaption_mode(modem_echo_can_state_t * ec , int adapt ) ;
...
modem_echo_can_update(modem_echo_can_state_t * ec , int16_t tx, int16_t
rx ) ;
