...
SPAN_DECLARE(void)
v27ter_tx_power(v27ter_tx_state_t * s , float power ) ;
...
SPAN_DECLARE(v27ter_tx_state_t * ) v27ter_tx_init(v27ter_tx_state_t * s , int bit_rate,
int tep, get_bit_func_t
get_bit , void *user_data ) ;
...
SPAN_DECLARE(int)
v27ter_tx_restart(v27ter_tx_state_t * s , int bit_rate,
int tep ) ;
...
/*! Release a V.27ter modem transmit context.
    ...
    \return 0 for OK */
SPAN_DECLARE(int)
v27ter_tx_release(v27ter_tx_state_t * s ) ;
...
/*! Free a V.27ter modem transmit context.
    ...
    \return 0 for OK */
SPAN_DECLARE(int)
v27ter_tx_free(v27ter_tx_state_t * s ) ;
...
/*! Change the get_bit function associated with a V.27ter modem transmit context.
    ...
    \param user_data An opaque pointer. */
SPAN_DECLARE(void)
v27ter_tx_set_get_bit(v27ter_tx_state_t * s , get_bit_func_t get_bit,
void *user_data ) ;
...
/*! Change the modem status report function associated with a V.27ter modem transmit context.
    ...
    \param user_data An opaque pointer. */
SPAN_DECLARE(void)
v27ter_tx_set_modem_status_handler(v27ter_tx_state_t * s , modem_tx_status_func_t handler,
void *user_data ) ;
...
v27ter_tx(v27ter_tx_state_t * s , int16_t amp[],
int len ) ;
