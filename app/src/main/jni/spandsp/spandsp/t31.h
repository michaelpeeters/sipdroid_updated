...
SPAN_DECLARE(void)
t31_call_event(t31_state_t * s , int event ) ;

SPAN_DECLARE(int)
t31_at_rx(t31_state_t * s , const char *t,
int len ) ;
...
SPAN_DECLARE(int)
t31_rx(t31_state_t * s , int16_t amp[],
int len ) ;
...
/*! Fake processing of a missing block of received T.31 modem audio samples
    ...
    \return The number of samples unprocessed. */
SPAN_DECLARE(int)
t31_rx_fillin(t31_state_t * s , int len ) ;
...
*/
SPAN_DECLARE(int)
t31_tx(t31_state_t * s , int16_t amp[],
int max_len ) ;

SPAN_DECLARE(int)
t31_t38_send_timeout(t31_state_t * s , int samples ) ;
...
*/
SPAN_DECLARE(void)
t31_set_transmit_on_idle(t31_state_t * s , int transmit_on_idle ) ;
...
*/
SPAN_DECLARE(void)
t31_set_tep_mode(t31_state_t * s , int use_tep ) ;
...
*/
SPAN_DECLARE(void)
t31_set_t38_config(t31_state_t * s , int without_pacing ) ;

SPAN_DECLARE(void)
t31_set_mode(t31_state_t * s , int t38_mode ) ;
