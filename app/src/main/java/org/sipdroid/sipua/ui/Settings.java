        ...
        switch (item.getItemId()) {
            case MENU_IMPORT:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(this, "Please grant external storage access.", Toast.LENGTH_SHORT).show();

                    // TODO: Consider calling
                    // check https://stackoverflow.com/questions/29915919/permission-denial-opening-provider-com-android-providers-contacts-contactsprovi
    ...
    private void exportSettings() {
        if (!settings.getString(PREF_USERNAME, "").equals("") && !settings.getString(PREF_SERVER, "").equals(""))
            try {
                ...
                Log.e("sipdroid", "cannot export settings", e);
    ...
    private OnClickListener profileOnClick = new DialogInterface.OnClickListener() {
        public void onClick(DialogInterface dialog, int whichItem) {
            ...
            try {
                ...
                Log.e("sipdroid", "cannot import settings", e);
